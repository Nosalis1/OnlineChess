...
public interface Streamable {
     ...
     * @throws networking.networkExceptions.InvalidBufferFormatException if the provided buffer has an invalid format
     */
    void unpack(String buffer) throws networking.networkExceptions.InvalidBufferFormatException;
}