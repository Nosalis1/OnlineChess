...
import networking.networkEvents.ServerEventHandler;
...
public abstract class Server {
    ...
    private static final Array<Socket> connectedSockets = new Array<>();
     ...
     */
    @SuppressWarnings("unused")
    public static Array<Socket> getConnectedSockets() {
