...
public class Vector implements networking.packageSystem.Streamable {
    public int x;
    public int y;
     ...
     * @throws networking.networkExceptions.InvalidBufferFormatException if the buffer is in an invalid format.
     */
    @Override
    public void unpack(String buffer) throws networking.networkExceptions.InvalidBufferFormatException {
        ...
        if (values.length == 2) {
            try {
                ...
                throw new networking.networkExceptions.InvalidBufferFormatException("Invalid buffer format. Expected comma-separated integers.", e);
            }
        } else {
            throw new networking.networkExceptions.InvalidBufferFormatException("Invalid buffer format. Expected two comma-separated values.");
        }
    }
}